...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.empresa'
        db.add_column(u'app_clientefrente', 'empresa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Empresa'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClienteFrente.puesto'
        db.add_column(u'app_clientefrente', 'puesto',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClienteFrente.referencia'
        db.add_column(u'app_clientefrente', 'referencia',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteFrente.empresa'
        db.delete_column(u'app_clientefrente', 'empresa_id')

        # Deleting field 'ClienteFrente.puesto'
        db.delete_column(u'app_clientefrente', 'puesto')

        # Deleting field 'ClienteFrente.referencia'
        db.delete_column(u'app_clientefrente', 'referencia')
