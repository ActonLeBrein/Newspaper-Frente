...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.rutas'
        db.add_column(u'app_clientefrente', 'rutas',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Ruta'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ClienteFrente.rutas'
        db.delete_column(u'app_clientefrente', 'rutas_id')
