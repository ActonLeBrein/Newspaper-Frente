...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cupon.cuponusado'
        db.alter_column(u'app_cupon', 'cuponusado', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=50, null=True))

        # Changing field 'Cupon.cantidad'
        db.alter_column(u'app_cupon', 'cantidad', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Cupon.cuponusado'
        db.alter_column(u'app_cupon', 'cuponusado', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True))

        # Changing field 'Cupon.cantidad'
        db.alter_column(u'app_cupon', 'cantidad', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True))
