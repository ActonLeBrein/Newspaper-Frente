...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.total'
        db.add_column(u'app_clientefrente', 'total',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClienteFrente.adicional'
        db.add_column(u'app_clientefrente', 'adicional',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteFrente.total'
        db.delete_column(u'app_clientefrente', 'total')

        # Deleting field 'ClienteFrente.adicional'
        db.delete_column(u'app_clientefrente', 'adicional')
