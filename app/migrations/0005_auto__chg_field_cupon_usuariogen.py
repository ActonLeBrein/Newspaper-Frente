...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cupon.usuariogen'
        db.alter_column(u'app_cupon', 'usuariogen_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Cupon.usuariogen'
        db.alter_column(u'app_cupon', 'usuariogen_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
