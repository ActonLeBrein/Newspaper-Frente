...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.dotacion'
        db.add_column(u'app_clientefrente', 'dotacion',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteFrente.dotacion'
        db.delete_column(u'app_clientefrente', 'dotacion')
