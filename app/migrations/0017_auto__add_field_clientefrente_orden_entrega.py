...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.orden_entrega'
        db.add_column(u'app_clientefrente', 'orden_entrega',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteFrente.orden_entrega'
        db.delete_column(u'app_clientefrente', 'orden_entrega')
