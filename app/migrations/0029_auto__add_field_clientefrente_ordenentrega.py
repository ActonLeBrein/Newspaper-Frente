...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.ordenentrega'
        db.add_column(u'app_clientefrente', 'ordenentrega',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteFrente.ordenentrega'
        db.delete_column(u'app_clientefrente', 'ordenentrega')
    ...
    models = {
        ...
        u'app.clientefrente': {
            ...
            'activo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'adicional': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'total': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        u'app.colonia': {
