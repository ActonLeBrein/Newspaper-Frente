...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.distribucion'
        db.add_column(u'app_clientefrente', 'distribucion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Canal_distribucion'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteFrente.distribucion'
        db.delete_column(u'app_clientefrente', 'distribucion_id')
