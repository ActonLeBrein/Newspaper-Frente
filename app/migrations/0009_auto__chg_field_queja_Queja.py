...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_queja', 'Queja', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Queja.Queja'
        db.alter_column(u'app_queja', 'Queja', self.gf('django.db.models.fields.TextField')(max_length=10))
