...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_queja', (
            ...
            ('Correo', self.gf('django.db.models.fields.EmailField')(max_length=80)),
            ('Telefono', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('Queja', self.gf('django.db.models.fields.TextField')(max_length=10)),
            ('Tipo_queja', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
