...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClienteFrente.total'
        db.alter_column(u'app_clientefrente', 'total', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True))

        # Changing field 'ClienteFrente.adicional'
        db.alter_column(u'app_clientefrente', 'adicional', self.gf('django.db.models.fields.IntegerField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'ClienteFrente.total'
        db.alter_column(u'app_clientefrente', 'total', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=50, null=True))

        # Changing field 'ClienteFrente.adicional'
        db.alter_column(u'app_clientefrente', 'adicional', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'app.clientefrente': {
            ...
            'activo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'adicional': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'dotacion': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'embolsado': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'orden_entrega': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'ordenentrega': ('django.db.models.fields.PositiveSmallIntegerField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'total': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        u'app.colonia': {
        ...
        u'app.delegacion_frente': {
            'Meta': {'ordering': "['descripcion_Delegacion']", 'object_name': 'Delegacion_frente'},
            'descripcion_Delegacion': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'app.empresa': {
        ...
        u'app.queja': {
            ...
            'Nombre': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'Queja': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'Telefono': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
            'Tipo_queja': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'activada': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_cliente': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'solucion': ('django.db.models.fields.TextField', [], {'max_length': '500'})
        },
        u'app.repartidor': {
