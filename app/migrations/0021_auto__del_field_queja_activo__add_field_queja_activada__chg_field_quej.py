...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Queja.activo'
        db.delete_column(u'app_queja', 'activo')
        ...
        # Changing field 'Queja.Tipo_queja'
        db.alter_column(u'app_queja', 'Tipo_queja', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Adding field 'Queja.activo'
        db.add_column(u'app_queja', 'activo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        # Changing field 'Queja.Tipo_queja'
        db.alter_column(u'app_queja', 'Tipo_queja', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))
