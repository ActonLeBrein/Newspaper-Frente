...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queja.activada'
        db.add_column(u'app_queja', 'activada',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Queja.solucion'
        db.add_column(u'app_queja', 'solucion',
                      self.gf('django.db.models.fields.TextField')(default=0, max_length=500),
                      keep_default=False)


        # Changing field 'Queja.Queja'
        db.alter_column(u'app_queja', 'Queja', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

    def backwards(self, orm):
        # Deleting field 'Queja.activada'
        db.delete_column(u'app_queja', 'activada')

        # Deleting field 'Queja.solucion'
        db.delete_column(u'app_queja', 'solucion')


        # Changing field 'Queja.Queja'
        db.alter_column(u'app_queja', 'Queja', self.gf('django.db.models.fields.TextField')(default=0, max_length=500))
