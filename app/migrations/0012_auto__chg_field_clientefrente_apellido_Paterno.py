...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClienteFrente.apellido_Paterno'
        db.alter_column(u'app_clientefrente', 'apellido_Paterno', self.gf('django.db.models.fields.CharField')(default=0, max_length=100))

    def backwards(self, orm):

        # Changing field 'ClienteFrente.apellido_Paterno'
        db.alter_column(u'app_clientefrente', 'apellido_Paterno', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
