...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Queja.Telefono'
        db.alter_column(u'app_queja', 'Telefono', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Queja.Telefono'
        db.alter_column(u'app_queja', 'Telefono', self.gf('django.db.models.fields.CharField')(default=0, max_length=10))
    ...
    models = {
        ...
        u'app.queja': {
            ...
            'Nombre': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'Queja': ('django.db.models.fields.TextField', [], {'max_length': '10'}),
