...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campania.aliado'
        db.add_column(u'app_campania', 'aliado',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Aliados'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Campania.aliado'
        db.delete_column(u'app_campania', 'aliado_id')
