...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Queja.id_cliente'
        db.alter_column(u'app_queja', 'id_cliente', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Queja.id_cliente'
        db.alter_column(u'app_queja', 'id_cliente', self.gf('django.db.models.fields.IntegerField')(default=0))
