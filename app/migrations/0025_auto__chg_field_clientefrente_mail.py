...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClienteFrente.mail'
        db.alter_column(u'app_clientefrente', 'mail', self.gf('django.db.models.fields.EmailField')(default=0, max_length=75))

    def backwards(self, orm):

        # Changing field 'ClienteFrente.mail'
        db.alter_column(u'app_clientefrente', 'mail', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
