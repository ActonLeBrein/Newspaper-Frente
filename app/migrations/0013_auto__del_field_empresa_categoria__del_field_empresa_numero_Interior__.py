...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Empresa.categoria'
        db.delete_column(u'app_empresa', 'categoria_id')

        # Deleting field 'Empresa.numero_Interior'
        db.delete_column(u'app_empresa', 'numero_Interior')

        # Deleting field 'Empresa.Colonia'
        db.delete_column(u'app_empresa', 'Colonia_id')

        # Deleting field 'Empresa.subcategoria2'
        db.delete_column(u'app_empresa', 'subcategoria2_id')

        # Deleting field 'Empresa.delegacion'
        db.delete_column(u'app_empresa', 'delegacion_id')

        # Deleting field 'Empresa.calle'
        db.delete_column(u'app_empresa', 'calle')

        # Deleting field 'Empresa.subcategoria1'
        db.delete_column(u'app_empresa', 'subcategoria1_id')

        # Deleting field 'Empresa.subcategoria3'
        db.delete_column(u'app_empresa', 'subcategoria3_id')

        # Deleting field 'Empresa.cliente'
        db.delete_column(u'app_empresa', 'cliente_id')

        # Deleting field 'Empresa.numero_Exterior'
        db.delete_column(u'app_empresa', 'numero_Exterior')
    ...
    def backwards(self, orm):
        # Adding field 'Empresa.categoria'
        db.add_column(u'app_empresa', 'categoria',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Categoria'], null=True),
                      keep_default=False)

        # Adding field 'Empresa.numero_Interior'
        db.add_column(u'app_empresa', 'numero_Interior',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Empresa.Colonia'
        db.add_column(u'app_empresa', 'Colonia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.Colonia']),
                      keep_default=False)

        # Adding field 'Empresa.subcategoria2'
        db.add_column(u'app_empresa', 'subcategoria2',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Subcategoria2'], null=True),
                      keep_default=False)

        # Adding field 'Empresa.delegacion'
        db.add_column(u'app_empresa', 'delegacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.Delegacion']),
                      keep_default=False)

        # Adding field 'Empresa.calle'
        db.add_column(u'app_empresa', 'calle',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Adding field 'Empresa.subcategoria1'
        db.add_column(u'app_empresa', 'subcategoria1',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Subcategoria1'], null=True),
                      keep_default=False)

        # Adding field 'Empresa.subcategoria3'
        db.add_column(u'app_empresa', 'subcategoria3',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Subcategoria3'], null=True),
                      keep_default=False)

        # Adding field 'Empresa.cliente'
        db.add_column(u'app_empresa', 'cliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.Cliente']),
                      keep_default=False)

        # Adding field 'Empresa.numero_Exterior'
        db.add_column(u'app_empresa', 'numero_Exterior',
