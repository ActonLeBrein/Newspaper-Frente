...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queja.id_cliente'
        db.add_column(u'app_queja', 'id_cliente',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queja.id_cliente'
        db.delete_column(u'app_queja', 'id_cliente')
    ...
    models = {
        ...
        u'app.queja': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_cliente': ('django.db.models.fields.IntegerField', [], {}),
